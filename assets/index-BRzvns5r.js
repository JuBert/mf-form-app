...
const moduleMap = {'react':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-BrALZ0a1.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-dom-B-igiCQ4.js', import.meta.url).href),import:true},'tailwindcss':{get:()=>()=>__federation_import$1(new URL('__federation_shared_tailwindcss-Bwvv78dv.js', import.meta.url).href),import:true}};
...
const remotesMap = {
'remoteApp':{url:'https://jubert.github.io/mf-component-library/assets/remoteEntry.js',format:'esm',from:'vite'}
};
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'19.1.1':{get:()=>get(new URL('__federation_shared_react-BrALZ0a1.js', import.meta.url).href), loaded:1}},'react-dom':{'19.1.1':{get:()=>get(new URL('__federation_shared_react-dom-B-igiCQ4.js', import.meta.url).href), loaded:1}},'tailwindcss':{'4.1.12':{get:()=>get(new URL('__federation_shared_tailwindcss-Bwvv78dv.js', import.meta.url).href), loaded:1}}
...
const __federation_var_remoteAppInputText = await __federation_method_getRemote("remoteApp" , "./InputText");
 let InputText = __federation_method_unwrapDefault(__federation_var_remoteAppInputText); 
const __federation_var_remoteAppInputDate = await __federation_method_getRemote("remoteApp" , "./InputDate");
 let InputDate = __federation_method_unwrapDefault(__federation_var_remoteAppInputDate); 
function App() {
  const [name, setName] = useState("");
  const [date, setDate] = useState("");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl w-full", children: "Host app" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-neutral-700 mt-6 p-6 rounded-lg space-y-4", children: [
